...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "kubernetes:eventing.knative.dev/v1beta2:EventType":
                return new EventType(name, <any>undefined, { urn })
            case "kubernetes:eventing.knative.dev/v1beta2:EventTypeList":
                return new EventTypeList(name, <any>undefined, { urn })
            case "kubernetes:eventing.knative.dev/v1beta2:EventTypePatch":
...
pulumi.runtime.registerResourceModule("knative-pulumi", "eventing.knative.dev/v1beta2", _module)
