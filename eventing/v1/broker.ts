...
export class Broker extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.eventing.v1.BrokerSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.eventing.v1.BrokerStatus>;
