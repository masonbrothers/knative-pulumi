...
export class Broker extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:eventing.knative.dev/v1:Broker';
    ...
    public readonly apiVersion!: pulumi.Output<"eventing.knative.dev/v1" | undefined>;
    public readonly kind!: pulumi.Output<"Broker" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    /**
     * Spec defines the desired state of the Broker.
     */
    public readonly spec!: pulumi.Output<outputs.eventing.v1.BrokerSpec | undefined>;
    /**
     * Status represents the current state of the Broker. This data may be out of date.
     */
    public readonly status!: pulumi.Output<outputs.eventing.v1.BrokerStatus | undefined>;
...
export interface BrokerArgs {
    apiVersion?: pulumi.Input<"eventing.knative.dev/v1">;
    kind?: pulumi.Input<"Broker">;
    metadata?: pulumi.Input<ObjectMeta>;
    /**
     * Spec defines the desired state of the Broker.
     */
    spec?: pulumi.Input<inputs.eventing.v1.BrokerSpecArgs>;
    /**
     * Status represents the current state of the Broker. This data may be out of date.
     */
    status?: pulumi.Input<inputs.eventing.v1.BrokerStatusArgs>;
}
