...
export class EventType extends pulumi.CustomResource {
    ...
    public readonly apiVersion!: pulumi.Output<"eventing.knative.dev/v1beta3" | undefined>;
    public readonly kind!: pulumi.Output<"EventType" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    /**
     * Spec defines the desired state of the EventType.
     */
    public readonly spec!: pulumi.Output<outputs.eventing.v1beta3.EventTypeSpec | undefined>;
    /**
     * Status represents the current state of the EventType. This data may be out of date.
     */
    public readonly status!: pulumi.Output<outputs.eventing.v1beta3.EventTypeStatus | undefined>;
...
export interface EventTypeArgs {
    apiVersion?: pulumi.Input<"eventing.knative.dev/v1beta3">;
    kind?: pulumi.Input<"EventType">;
    metadata?: pulumi.Input<ObjectMeta>;
    /**
     * Spec defines the desired state of the EventType.
     */
    spec?: pulumi.Input<inputs.eventing.v1beta3.EventTypeSpecArgs>;
    /**
     * Status represents the current state of the EventType. This data may be out of date.
     */
    status?: pulumi.Input<inputs.eventing.v1beta3.EventTypeStatusArgs>;
}
