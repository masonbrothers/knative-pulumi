...
export class EventType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:eventing.knative.dev/v1beta3:EventType';
    ...
    declare public readonly spec: pulumi.Output<outputs.eventing.v1beta3.EventTypeSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.eventing.v1beta3.EventTypeStatus>;
    ...
    constructor(name: string, args?: EventTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:eventing.knative.dev/v1beta1:EventType" }, { type: "kubernetes:eventing.knative.dev/v1beta2:EventType" }] };
