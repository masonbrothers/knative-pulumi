...
export class RequestReply extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RequestReply {
        return new RequestReply(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:eventing.knative.dev/v1alpha1:RequestReply';

    /**
     * Returns true if the given object is an instance of RequestReply.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RequestReply {
     ...
     */
    constructor(name: string, args?: RequestReplyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RequestReply.__pulumiType, name, resourceInputs, opts);
    }
}
