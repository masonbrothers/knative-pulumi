...
export class Revision extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Revision {
        return new Revision(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:serving.knative.dev/v1:Revision';
    ...
    declare public readonly spec: pulumi.Output<outputs.serving.v1.RevisionSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.serving.v1.RevisionStatus>;
