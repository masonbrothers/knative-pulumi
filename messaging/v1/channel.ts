...
export class Channel extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.messaging.v1.ChannelSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.messaging.v1.ChannelStatus>;
