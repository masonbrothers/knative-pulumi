...
export class CertificatePatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.internal.knative.dev/v1alpha1:CertificatePatch';
    ...
    declare public readonly spec: pulumi.Output<outputs.networking.v1alpha1.CertificateSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.networking.v1alpha1.CertificateStatusPatch>;
...
export interface CertificatePatchArgs {
    ...
    spec?: pulumi.Input<inputs.networking.v1alpha1.CertificateSpecPatch | undefined>;
}
