...
export class IngressPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.internal.knative.dev/v1alpha1:IngressPatch';
    ...
    declare public readonly spec: pulumi.Output<outputs.networking.v1alpha1.IngressSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.networking.v1alpha1.IngressStatusPatch>;
...
export interface IngressPatchArgs {
    ...
    spec?: pulumi.Input<inputs.networking.v1alpha1.IngressSpecPatch | undefined>;
}
